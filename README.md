# Flask + ReactJS
This is a full stack web application development using Python Flask and the ReactJS library.


## About the project
The project is a simple web app that allows simple signup and login against a Flask REST API.
